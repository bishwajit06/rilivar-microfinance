                            ...
                            @foreach ($branches as $key => $branch)
                                <tr>
                                    ...
                                    <div class="modal fade" id="exampleModal{{$branch->slug}}" tabindex="-1" aria-labelledby="exampleModal{{$branch->slug}}Label" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content p-4">
                                                <form action="{{route('user.branch.update',$branch->id)}}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <form id="delete-form-{{ $branch->id }}" action="{{ route('user.branch.destroy',$branch->id) }}" method="post" style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    </td>
