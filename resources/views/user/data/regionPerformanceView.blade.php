...
@section('content')
    <div class="card mb-3 border-0">
        <div class="card-header bg-white border-0">
            <h5 class="mt-3">Top Rank performance by Region</h5>
        </div>
        <div class="card-body">
            <div class="row justify-content-between">
                <div class="col-lg-3">
                    <form action="{{route('user.regionPerformanceDataFilter')}}" method="get">
                        @csrf
                        <div class="d-flex">
                            <div class="mb-3">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $result = 0;
                                        @endphp
                                            @if ($region->staff()->count() > 0)
                                                @php
                                                    $collection = collect([]);
                                                    $sorted = [];
                                                @endphp
                                                @foreach ($region->staff as $staff)
                                                @php
                                                ...
                                                @if ($sorted)
                                                    ...
                                                    @endforeach
                                                    <tr>
                                                        <th style="min-width:120px">{{$region->name}}</th>
                                                        <th>Total</th>
                                                        <th>{{$result}}/=</th>
                                                    </tr>
                                                @endif
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            ...
                                            @php
                                                ...
                                                $sorted = [];
                                            @endphp
                                            @foreach ($region->staff as $key => $staff)
                                                @php
                                            ...
                                            @if ($region->staff->count() > 0)
                                                ...
                                                @if ($sorted)
                                                    @foreach ($sorted as $item)
                                                        <tr>
                                                        <td style="min-width:220px">{{$item['name']}}</td>
                                                        <td style="min-width:140px">{{$item['total_collection']}}</td>
                                                        @php
                                            ...
                                            @if ($region->staff->count() > 0)
                                                ...
                                                @if ($sorted)
                                                    @foreach ($sorted as $item)
                                                        <tr>
                                                        <td style="min-width:220px">{{$item['name']}}</td>
                                                        <td style="min-width:140px">{{$item['otr']}}</td>
                                                        @php
                                                    ...
                                                    <tr>
                                                        <th>Total</th>
                                                        <th style="min-width:120px">{{number_format($result / $sorted->count(), 2)}}%</th>
                                                    </tr>
                                                @endif
                                            @endif
                                        @endforeach
                                            ...
                                            @if ($region->staff->count() > 0)
                                                ...
                                                @if ($sorted)
                                                    @foreach ($sorted as $item)
                                                        <tr>
                                                        <td style="min-width:220px">{{$item['name']}}</td>
                                                        <td style="min-width:140px">{{$item['new_due']}}</td>
                                                        @php
                                            ...
                                            @if ($region->staff->count() > 0)
                                                ...
                                                @if ($sorted)
                                                    @foreach ($sorted as $item)
                                                        <tr>
                                                        <td style="min-width:220px">{{$item['name']}}</td>
                                                        <td style="min-width:140px">{{$item['inc_dic']}}</td>
                                                        @php
